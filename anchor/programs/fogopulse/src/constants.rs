...
/// Default maximum trade amount in USDC lamports (6 decimals)
/// 100_000_000 = $100 USDC - used as initial value in GlobalConfig
pub const DEFAULT_MAX_TRADE_AMOUNT: u64 = 100_000_000;
