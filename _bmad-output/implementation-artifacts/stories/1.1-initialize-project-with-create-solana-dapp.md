...
### Checklist
- [ ] Run create-solana-dapp with counter template
- [ ] Verify scaffold created anchor/ and web/ directories
- [ ] Verify _bmad/, _bmad-output/, docs/, .claude/ preserved
- [ ] Rename program from "counter" to "fogopulse"
- [ ] Configure Anchor.toml for FOGO (per constraints)
- [ ] Run pnpm install successfully
- [ ] Run pnpm build successfully (root)
- [ ] Run anchor build successfully
- [ ] Run pnpm build successfully (web/)
- [ ] Initialize git repository if not present
- [ ] Commit scaffold with meaningful message
